package com.reverigma.habittrack
...
import com.reverigma.habittrack.ui.lock.LockScreen
import com.reverigma.habittrack.ui.settings.SettingsScreen
import com.reverigma.habittrack.ui.settings.SettingsViewModel
            ...
            MementideTheme {
                ...
                Scaffold(
                    ...
                    when (selected) {
                        ...
                        2 -> SettingsScreen(settingsVm, Modifier.fillMaxSize().padding(padding))
                    }
                }
