package com.reverigma.habittrack.util
...
object DateUtils {
    ...
    fun fromEpochMillis(millis: Long): String =
        Instant.ofEpochMilli(millis).atZone(ZoneId.systemDefault()).toLocalDate().format(ISO)
    ...
    private fun minusDays(date: String, n: Int): String =
        parse(date).minusDays(n.toLong()).format(ISO)
